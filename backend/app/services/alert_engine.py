    ...
    return [
        {
            ...
            "order_total_amount": agg.get("order_total_amount"),
            "tax_inclusive_unit_price": agg.get("tax_inclusive_unit_price"),
    ...
    for group in groups:
        ...
        for line in _line_inputs(group):
            ...
            payload_common = {
                ...
                "amount": amount,
                "order_total_amount": _to_float(line.get("order_total_amount")),
                "tax_inclusive_unit_price": _to_float(line.get("tax_inclusive_unit_price")),
